...
trait LogCapturing {
  ...
  val nameFromHods: NameFromHods = NameFromHods(Some(TEST_TAXPAYER))

  val nameFromHodsJsonString: String = """{"name":{"title":"test_title","forename":"test_name"}}""".stripMargin
  val nameFromHodsInvalidJsonString: String = """{"name":{"title":true,"forename":"test_name"}}""".stripMargin
